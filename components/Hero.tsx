        ...
        <div className="grid w-full grid-cols-1 items-center lg:grid-cols-12">
          ...
          <div className="lg:col-span-6 flex justify-end">
            <div className="space-y-0 md:space-y-6 w-full">
              ...
              <div className="md:hidden bg-[#1b3047] px-8 py-10 text-white text-center shadow-lg">
              ...
              <div className="hidden md:flex md:flex-col md:items-start md:w-[min(680px,100%)]">
                <div className="bg-[#1b3047] px-8 py-3 text-sm font-medium tracking-wide text-white shadow-sm">
                  Welcome to prosla
                </div>

                <div className="mt-6 w-full bg-[#1b3047] px-8 py-10 text-white shadow-lg md:px-10">
