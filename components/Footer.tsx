...
import { Instagram, Youtube, Linkedin, Bookmark, Mail } from "lucide-react"; // Added Mail icon
      ...
      <div className="flex w-full flex-col gap-6 px-6 md:px-10">
        ...
        <div className="flex w-full items-center justify-between">
          ...
          <div className="flex items-center gap-5 text-zinc-400">
            ...
            {/* X (Twitter) */}
            <Link href="#" className="hover:text-zinc-600 dark:hover:text-zinc-300">
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-3.5 w-3.5" aria-label="X">
            ...
            {/* WhatsApp */}
            <Link href="#" className="hover:text-zinc-600 dark:hover:text-zinc-300">
              <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4" aria-label="WhatsApp">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
          ...
          <div className="space-y-6">
            <p className="text-sm font-light text-zinc-500">
              © {currentYear} PROSLA™ Method. All rights reserved.
            </p>

            <div className="flex gap-6 text-sm text-zinc-600 dark:text-zinc-400">
              {/* UPDATED: Link to the actual Legal Page */}
              <Link href="/legal" className="hover:text-black dark:hover:text-white">
                Privacy
              </Link>
              <Link href="/legal" className="hover:text-black dark:hover:text-white">
                Terms
              </Link>
              <a href="mailto:hello@brinl.com" className="hover:text-black dark:hover:text-white">
                Contact
              </a>
            </div>
          </div>

          {/* ADDED: Site by Brinl Credit (Right side on desktop) */}
