...
const publications = [
  {
    id: 1,
    title: "Pedagogy in Border Contexts: A Case Study",
    journal: "Journal of Latin American Educational Studies",
    year: "2024",
    url: "#", // Add actual links if you have them
  },
  {
    id: 2,
...
export default function About() {
  return (
    <main className="min-h-screen bg-[#f5f2ea] text-zinc-900 overflow-x-hidden">
      {/* HEADER & HERO SECTIONS (Unchanged) */}
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-7xl space-y-12 px-6 py-12 md:px-16 md:py-16">
          <div className="ml-0 pl-6 space-y-10 md:ml-24 md:pl-8 md:space-y-12">
            ...
            {/* 2. NEW SECTION: Featured Publications */}
              ...
              <ul className="space-y-4 md:space-y-6">
                {publications.map((pub) => (
                  <li key={pub.id} className="flex flex-col gap-1">
                    <Link
                      href={pub.url}
                      className="group block font-medium decoration-zinc-300 underline-offset-4 hover:underline"
                    >
                      {pub.title} ↗
                    </Link>
                    <span className="text-base text-zinc-500 md:text-lg">
